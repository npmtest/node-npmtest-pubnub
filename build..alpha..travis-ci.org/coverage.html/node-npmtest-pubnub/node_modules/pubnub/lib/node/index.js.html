...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-pubnub/node_modules/pubnub/lib/node/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-pubnub/node_modules/pubnub/lib/node/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-pubnub/node_modules/pubnub/lib/node/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function _class(setup) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, _class);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    setup.db = new _common2.default();</span>
<span class="cstat-no" title="statement not covered" >    setup.networking = new _networking2.default({ keepAlive: _node.keepAlive, get: _webNode.get, post: _webNode.post, proxy: _node.proxy });</span>
<span class="cstat-no" title="statement not covered" >    setup.sdkFamily = 'Nodejs';</span>
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, setup));</span>
  }
&nbsp;
  return _class;
